async function realisationsMain() {
  ...
  let realisations = [
    {
      ...
      image: "./frontend/public/images/groupomania.webp",
    ...
    },
    {
      ...
      image: " ./frontend/public/images/ohmyfood.webp",
      link: "https://github.com/Peacepad/ohmyfood",
    },
    {
      name: "La chouette Agence",
      description:
        "Optimiser le référencement SEO d'un site web existant, tout en améliorant l'accessibilité du site, les performances.",
      image: " ./frontend/public/images/lachouetteagence.webp",
      link: "https://github.com/Peacepad/lachouetteagence",
    },
    {
      name: "Piquante",
      description:
        "Le front-end de l'application a été développé à l'aide d'Angular mais Piiquante a besoin d'un développeur pour construire l'API.",
      image: "./frontend/public/images/piquante.webp",
      link: "https://github.com/Peacepad/piquante",
    },
    {
      name: "Orinoco",
      description:
        "Création du front-end d'un site e-commerce en Javascript en utilisant un API fourni.",
      image: "./frontend/public/images/orinoco.webp",
  ...
  const realisationLetter = document.querySelector("#realisation-letter");
